...
|---------|------|----------|
| **Akhil Teja Chirra (A)** | Task 1 (Symbolic) | EDA, Data, Preprocessing |
| **Narain Shriraam MS (B)** | Task 1 (Symbolic) | Modeling, Evaluation, Related Work |
| **Priyansh Parikh (C)** | Task 4 (Continuous) | EDA, Data, Preprocessing, Modeling |
| **Jeevan N V (D)** | Task 4 (Continuous) | Evaluation, Related Work, Conclusion |
...
I'll continue directly with the data and preprocessing on Task 1."

**Transition cue:** Akhil continues directly into Task 1 EDA.

---

### 1:30 - 3:45 — Task 1: EDA, Data Collection, Preprocessing (Akhil)
...
**Show:** Notebook Cell 6 output (length, interval, pitch usage distributions)
...
**Transition cue:** Narain takes over.

---


──────────────────────────────────────────────────────────────
## ◀  AKHIL TEJA CHIRRA — END (3:45)
## ▶  NARAIN SHRIRAAM MS — START (3:45)
──────────────────────────────────────────────────────────────

### 3:45 - 7:00 — Task 1: Modeling (Narain)
...
**Transition cue:** Narain continues.

---

### 7:00 - 9:00 — Task 1: Evaluation (Narain)
...
Now Priyansh will cover Task 4."

**Transition cue:** Priyansh takes over.

---


──────────────────────────────────────────────────────────────
## ◀  NARAIN SHRIRAAM MS — END (9:00)
## ▶  PRIYANSH PARIKH — START (9:00)
──────────────────────────────────────────────────────────────

### 9:00 - 11:30 — Task 4: EDA, Data Collection, Preprocessing (Priyansh)
...
### 11:30 - 14:00 — Task 4: Modeling (Priyansh)
...
Jeevan will take it from here for Task 4 evaluation."

**Transition cue:** Jeevan takes over.

---


──────────────────────────────────────────────────────────────
## ◀  PRIYANSH PARIKH — END (14:00)
## ▶  JEEVAN N V — START (14:00)
──────────────────────────────────────────────────────────────

### 14:00 - 16:30 — Task 4: Evaluation (Jeevan)
...
### 16:30 - 18:00 — Related Work for Both Tasks (Jeevan)
...
──────────────────────────────────────────────────────────────
## ◀  JEEVAN N V — END (18:00)
## ▶  AKHIL TEJA CHIRRA (returns) — START (18:00)
──────────────────────────────────────────────────────────────

### 18:00 - 19:30 — Cross-Task Comparison and Conclusion (Akhil)
...
──────────────────────────────────────────────────────────────
## ◀  AKHIL TEJA CHIRRA — END (20:00)
> Music playback section — does NOT count toward 20 min
──────────────────────────────────────────────────────────────
...
──────────────────────────────────────────────────────────────
## ▶  NARAIN SHRIRAAM MS — PLAYBACK (Task 1 MIDI audio)
──────────────────────────────────────────────────────────────

#### Task 1 Playback (Narain)
...
──────────────────────────────────────────────────────────────
## ▶  JEEVAN N V — PLAYBACK (Task 4 audio)
──────────────────────────────────────────────────────────────

#### Task 4 Playback (Jeevan)
...
──────────────────────────────────────────────────────────────
## ◀  PRESENTATION COMPLETE  ·  All speakers done
──────────────────────────────────────────────────────────────
